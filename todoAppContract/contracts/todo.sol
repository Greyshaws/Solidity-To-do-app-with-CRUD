/*** So this licence is really important because of Legal reasons, for when someone uses your code, if you don't want it you could use 
...
// A 'struct' is a way to pair up a bunch of related variables instead of declaring then everytime over and over again
...
// I am thinking this functions name gives it away already, it's a 'createTodo' function and it just takes two paramenters
...
// but you could do your futher readings on others
      ...
      // returns function modifier, lets the EVM know that the function would have to return something and in this case 
      ...
      // we did not return only one but 2 beecause of the 'returns' function modifier
